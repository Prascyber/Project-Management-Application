...
const Team = () => {
  const member = [{
    ...
    bio: "I have expertise in full-stack web development, Android app and MERN stack development. I am knowledgeable in various programming languages, frameworks, and technologies and strive to create high-quality, user-friendly applications."
  }]
  return (
    <TeamWrapper id="team">
